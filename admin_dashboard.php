...
<body>
    ...
    <main>
        ...
        <div class="widget-container">
            ...
            <div class="widget">
               <div class="stat-item">
               <strong>Total Users:</strong> <span id="total-users" class="loading">Loading...</span>
               </div>
            ...
            <div class="widget">
               <div class="stat-item">
               <strong>Total Admins:</strong> <span id="total-admins" class="loading">Loading...</span>
               </div>
            ...
            <div class="widget">
                 <div class="stat-item">
                 <strong>Total Staffs:</strong> <span id="total-staff" class="loading">Loading...</span>
                 </div>
            ...
            <div class="widget">
                 <div class="stat-item">
                 <strong>Total Customers:</strong> <span id="total-customers" class="loading">Loading...</span>
                 </div>
